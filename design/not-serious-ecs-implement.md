...
1. 为什么没有使用AddPart&lt;T&gt;\(\)这种泛型接口，而是使用了AddPart\(Type type\)？
...
1. 根据《守望先锋》的经验，它们最终有大约40%的组件是Singleton，在框架中如何支持？另外，某些组件可能需要频繁的创建和销毁，是否应该考虑加入Pool的方案？
