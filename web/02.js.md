...
##### 2 [js设计失误清单](https://www.zjl.me/2020/11/14/javascript-%E7%9A%84%E8%AE%BE%E8%AE%A1%E5%A4%B1%E8%AF%AF/)

1. ==运算：因为试图转换类型后比较，所以被弃用。推荐显示转换类型后，使用===比较
2. with关键字：副作用巨多，不要用
